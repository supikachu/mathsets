...
/**
 * AppIcon — unified SF Symbols-inspired icon system.
 * Replaces all emoji icons with crisp, consistent line icons.
 * All icons use currentColor and a shared 1.6 stroke weight.
 */
withDefaults(
  defineProps<{
    name: string
...
<template>
  ...
  >
    ...
    <template v-else-if="name === 'files'">
      ...
      <path d="M18 21H8a2 2 0 0 1-2-2V7a2 2 0 0 1 2-2h6l4 4v10a2 2 0 0 1-2 2z" />
      <path d="M4 5a2 2 0 0 1 2-2" opacity="0.5" />
    </template>
    ...
    <template v-else-if="name === 'users'">
      ...
      <path d="M16 3.5a3.5 3.5 0 0 1 0 7" opacity="0.6" />
      <path d="M22 21v-1a5 5 0 0 0-4-4.9" opacity="0.6" />
    </template>
    ...
    <template v-else-if="name === 'sparkles'">
      ...
      <path d="M19 3v4M21 5h-4M5 17v2M6 18H4" opacity="0.7" />
    </template>
    ...
    <template v-else-if="name === 'pin'">
      <path d="M12 17v5" />
      <path d="M9 10.76V4a1 1 0 0 1 1-1h4a1 1 0 0 1 1 1v6.76a2 2 0 0 0 .59 1.41l1.7 1.7A1 1 0 0 1 16.59 17H7.4a1 1 0 0 1-.7-1.71l1.7-1.7A2 2 0 0 0 9 10.76z" />
    </template>
    <template v-else-if="name === 'folder'">
      <path d="M4 5a2 2 0 0 1 2-2h3l2 2h7a2 2 0 0 1 2 2v9a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5z" />
    </template>
    <template v-else-if="name === 'folder-open'">
      <path d="M4 5a2 2 0 0 1 2-2h3l2 2h7a2 2 0 0 1 2 2v1H4z" />
      <path d="M2 9h20l-2.5 8.5a2 2 0 0 1-1.9 1.5H6.4a2 2 0 0 1-1.9-1.5z" />
    </template>
    <template v-else-if="name === 'star'">
      <path d="M12 2.5l2.9 6.1 6.6.9-4.8 4.6 1.2 6.5L12 18l-5.9 3.1 1.2-6.5L2.5 9.5l6.6-.9z" />
    </template>
