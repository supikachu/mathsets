<template>
  <div class="edit-page">
    ...
    <template v-if="!isNew && loading">
      ...
      <el-row :gutter="16">
        <el-col :span="17"><el-skeleton :rows="8" animated /></el-col>
        <el-col :span="7"><el-skeleton :rows="10" animated /></el-col>
      </el-row>
    </template>
      ...
      <div class="edit-body">
        ...
        <div class="edit-left">
          <el-card shadow="never" class="mb-3">
            ...
            <el-input v-model="form.stem" type="textarea" :rows="6" placeholder="输入题目内容，LaTeX 公式用 $...$ 包裹" />
          </el-card>
          ...
          <el-card shadow="never" class="mb-3">
            ...
            <el-input v-model="form.analysis" type="textarea" :rows="4" placeholder="解题思路与易错点，支持 $...$ LaTeX" />
          </el-card>
        </div>
              ...
              <div v-for="node in kpTree" :key="node.id">
                ...
                <div class="ml-3" v-if="node.children?.length">
                  <div v-for="c in node.children" :key="c.id">
                    <el-checkbox v-model="form.knowledgePointIds" :label="c.id" :value="c.id" size="small">{{ c.name }}</el-checkbox>
                  </div>
                </div>
              </div>
